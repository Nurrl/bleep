...
#
#################################################################
XTENSA_TOOLCHAIN_ROOT ?= ./xtensa-toolchain

# Base directory for the compiler
XTENSA_TOOLS_ROOT ?= $(XTENSA_TOOLCHAIN_ROOT)/release/xtensa-toolchain/xtensa-lx106-elf/bin
...
ESPTOOL		?= $(XTENSA_TOOLCHAIN_ROOT)/bin/esptool.py
ESPPORT		?= /dev/ttyUSB0
...
#
#################################################################
FW_TOOL		?= $(XTENSA_TOOLCHAIN_ROOT)/release/bin/esptool
SRC_DIR		:= $(MODULES)
